<template>
  <div class="border-top py-3 d-flex justify-content-between align-items-center">
    <span>
      &copy; <a href="https://www.linkedin.com/in/younoch/" class="text-decoration-none" title="Linked in Mohammad Younoch">Mohammad Younoch</a> <Refs />
    </span>
    <a href="https://github.com/younoch" class="text-decoration-none" title="Boilerplate for Vue 3 with Vite and Bootstrap 5 with Icons">
